...
def attack(char_name: str, char_class: str) -> str:
    """Проверить класс персонажа и нанести ему урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Проверить класс персонажа и блокировать урон."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Проверить класс персонажа и применить умение."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Проверить класс персонажа и потренировать навык или пропустить."""
    if char_class == 'warrior':
    ...
    print('defence — чтобы блокировать '
          'или special — чтобы использовать суперсилу.')
...
def choice_char_class() -> str:
    """Ввести название персонажа и подтвердить выбор."""
    approve_choice: str = ''
    char_class: str = ''
    while approve_choice != 'y':
        char_class = input('Введи название персонажа: Воитель — warrior, '
